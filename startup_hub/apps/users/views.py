...
def user_activity(request):
    ...
    # Get recent ratings
    recent_ratings = user.startuprating_set.select_related('startup').order_by('-created_at')[:5]
    
    # Get recent comments
    recent_comments = user.startupcomment_set.select_related('startup').order_by('-created_at')[:5]
    
    # Get bookmarked startups
    bookmarks = user.startupbookmark_set.select_related('startup').order_by('-created_at')[:10]
    
    # Get liked startups
    likes = user.startuplike_set.select_related('startup').order_by('-created_at')[:10]
